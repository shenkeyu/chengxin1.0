...
response.setContentType("text/html;charset=UTF-8");
     ...
     session.setAttribute("chaxunyonghu", ss);
	};
 try{
	Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");//加载JDBC驱动器类
		...
		//String ss=request.getParameter("mingzi").toString();		
		//String ss=new String(request.getParameter("mingzi").getBytes("ISO-8859-1"),"gb2312");
		...
		String sql3="select * from person where personname like '%"+session.getAttribute("chaxunyonghu").toString().trim()+"%'";    
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////							  
%>
								<td style="vertical-align:middle;align:left;width:323px;margin-top:20px;">
										...
										<form style="center" action="gerenxiangdan.jsp" method="post" >
										<input name="gerennamexiang" type="hidden" value="<%=rs3.getString("personname").trim()%>">
										<input name="gerenIDcardxiang" type="hidden" value="<%=rs3.getString("personIDcard").trim()%>">
...
<div style="margin-top:30px;"></div>
      ...
      %>
       <td width=150>
        <a href="grxyneirong.jsp?ToPage=<%=1 %>">第一页</a>
       </td> 
       <td width=150>
        <a href="grxyneirong.jsp?ToPage=<%=ShowPage-1 %>">上一页</a>
       </td>
      <% 
       };
       ...
       %>
        <td width=150>
         <a href="grxyneirong.jsp?ToPage=<%=ShowPage+1 %>">下一页</a>
        </td>
        <td width=150>
         <a href="grxyneirong.jsp?ToPage=<%=PageCount%>">最后一页</a>
        </td>
       <%
        };
       %>
         ...
         <div style="margin-top:30px;"></div>
          <form action="grxyneirong.jsp" method="post" name="form1">
