 ...
 try{
	...
	Connection con = null;
		...
		Statement stmt= con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
				  ...
				  while(rs.next())
				  {
				  float fenshu=Float.parseFloat(rs.getString("personfenshu").trim());
							  if(fenshu>120)
							  {
...
%>
								<td style="vertical-align:middle;align:left;width:323px">
										...
										<br>
										<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										姓名：<%=rs.getString("personname").trim()%>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<br>&nbsp;
										<br>&nbsp;
										<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										部门：<%=rs.getString("personbumen").trim()%><br>
										<br>&nbsp;
										<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 try{
	Connection con1 = null;
		...
		Statement stmt1= con1.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
				  ...
				  while(rs1.next())
				  {
				  float fenshu=Float.parseFloat(rs1.getString("personfenshu").trim());
							  if(fenshu>120)
							  {
...
%>
		<td style="vertical-align:middle;align:left;width:323px">
				...
				<br>
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				姓名：<%=rs1.getString("personname").trim()%>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<br>&nbsp;
				<br>&nbsp;
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				部门：<%=rs1.getString("personbumen").trim()%><br>
				<br>&nbsp;
				<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
