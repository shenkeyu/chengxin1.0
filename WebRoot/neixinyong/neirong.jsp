...
%>
<body>
<center><div style="font-size:20px;margin-top:20px">内分包商清单</div></center>
<%
...
response.setContentType("text/html;charset=UTF-8");
     ...
     session.setAttribute("chaxunnei", ss);
	};
 try{
	Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");//加载JDBC驱动器类
		...
		String sql3="select * from nei where name like '%"+session.getAttribute("chaxunnei").toString().trim()+"%'";    
