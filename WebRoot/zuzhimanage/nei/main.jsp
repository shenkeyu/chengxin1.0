...
<div style="margin-top:7px;"><img src="../../image/menu/self_16.png" alt="内分包商管理" style="height:22px;width:22px;vertical-align:middle;"/>内分包商管理</div>
</div>
<%
...
%>
   ...
   <a href="AddRecord.jsp" style="color:blue;">增加内分包商</a>
   </div>
   </div>
   ...
   <table cellspacing="0" cellpadding="0" style="margin-left:20px;margin-top:20px;border:1px solid #CCCCCC;height:50px;">
            <tr>
         	<td style="width:170px;font-size:15px;border:1px solid #CCCCCC;height:50px;"  align="center">内分包商名称：</td>
