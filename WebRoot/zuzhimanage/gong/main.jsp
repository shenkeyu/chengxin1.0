...
<div style="margin-top:7px;"><img src="../../image/menu/self_16.png" alt="内分包商管理" style="height:22px;width:22px;vertical-align:middle;"/>供应商管理</div>
</div>
<%
String quanxian=session.getAttribute("bumen").toString().trim();
if(quanxian.equals("综合计划处")){
System.out.println("供应商管理成功！");
}else{
System.out.println("供应商管理失败！");
String path = request.getContextPath();
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
out.println("<script>window.alert('没有供应商管理权限');window.location.href='"+basePath+"gerenxinyong/grxymain.jsp';</script>");
};
...
%>
   ...
   <a href="AddRecord.jsp" style="color:blue;">增加供应商</a>
   </div>
   </div>
   ...
   <table cellspacing="0" cellpadding="0" style="margin-left:20px;margin-top:20px;border:1px solid #CCCCCC;height:50px;">
            <tr>
         	<td style="width:170px;font-size:15px;border:1px solid #CCCCCC;height:50px;"  align="center">供应商名称：</td>
