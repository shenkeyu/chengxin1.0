						     ...
						     if(flagpanduan1==true){     
								 	  try{
								 			...
								 			Statement stmt= con.createStatement();
											      String sql="update nei set dizhi='"+dizhi.trim()+"',faren='"+faren.trim()+"',ziben='"+ziben.trim()+"',chengliriqi='"+chengliriqi.trim()+"',yingyeriqi='"+yingyeriqi.trim()+"' where id="+name.trim();
