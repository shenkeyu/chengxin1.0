    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {  
		...
		System.out.println(sql+"////");
			if(flag){
					...
					out.println("计分成功!<br>"+gongname+"<br>因为"+gongdo+"<br>计"+String.valueOf(gongfen)+"分<br>上月得分为"+String.valueOf(gongfenshu)+"分。<br><a href='javascript:window.history.go(-2)'>返回</a>");
					//////////////////////////日志记录//////////////////////////////////
					String rizhi=gongname.trim()+"，因为"+gongdo.trim()+"，计"+String.valueOf(gongfen).trim()+"分";
